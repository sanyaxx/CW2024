...
public class LevelCompletedOverlay {
    ...
    public LevelCompletedOverlay(Scene scene) {
        this.scene = scene;
        ...
        completionMessage = new Label("Level Completed!");
        ...
        HBox buttonContainer = new HBox(20, nextLevelButton.getNextLevelButton(), startPageButton.getStartPageButton());
